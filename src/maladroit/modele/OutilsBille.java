 ...
 * 
 * */
public static Vector<BilleMaladroit> autresBilles(BilleMaladroit cetteBille, Vector<BilleMaladroit> billes)
{
Vector<BilleMaladroit> autresBilles = new Vector<BilleMaladroit>();
 ...
 * */
public static  boolean gestionCollisionBilleBille(BilleMaladroit cetteBille, Vector<BilleMaladroit> billes)
{
//--- on r�cup�re d'abord dans autresBilles toutes les billes sauf cetteBille ----

Vector<BilleMaladroit> autresBilles = OutilsBille.autresBilles(cetteBille, billes);
 ...
 * 
 * */
public static Vecteur gestionAccelerationNewton(BilleMaladroit cetteBille, Vector<BilleMaladroit> billes)
{
