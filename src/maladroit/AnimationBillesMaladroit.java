 ...
 * */
public class AnimationBillesMaladroit implements Runnable
{


Vector<BilleMaladroit> billes;   // la liste de toutes les billes en mouvement
VueBillardMaladroit vueBillard;    // la vue responsable du dessin des billes
 ...
 * @param vueBillard
 */
public AnimationBillesMaladroit(Vector<BilleMaladroit> billes, VueBillardMaladroit vueBillard)
{
this.billes = billes;
...
try
    ...
    BilleMaladroit billeCourante;
    
    double minRayons = AnimationBillesMaladroit.minRayons(billes);   //n�cessaire au calcul de deltaT
 ...
 * 
 * */
static double maxVitessesCarrees(Vector<BilleMaladroit> billes)
{
 ...
 * 
 * */
static double minRayons(Vector<BilleMaladroit> billes)
{
