...
//--------------- ici commence la partie à changer ---------------------------------
        ...
        BilleDynamique bd2 = new BilleDynamique(p3,rayon,v3,new Vecteur(0,0.0025),Couleur.vert, observateur);
        ...
        BilleDynamique bd7 = new BilleDynamique(p6, rayon, v6, new Vecteur(0, 0.0025), Couleur.rouge, observateur);
        BilleDynamique bd8 = new BilleDynamique(p7, rayon, v7, new Vecteur(0, 0.0025), Couleur.noir);
        BilleDynamique bd9 = new BilleDynamique(p8, rayon, v8, new Vecteur(0, 0.0025), Couleur.bleu, observateur);
        ...
        DecorateurBille b9 = new DecorateurPoissonGlobe(bd9);
